...
// Wrapper 객체: 기본 타입(Byte, char, short, int, long, float, double, boolean) 값을 갖는 객체 생성 가능
// - 포장 객체를 생성하기 위한 클래스는 java.lang 패키지에 포함되어 있음
// - 포장 객체는 포장하고 있는 기본 타입의 값을 변경할 수 없고, 단지 객체를 생성하는데 목적이 있음
// - 컬렉션 때문!
// - 컬렉션 객체는 기본 타입의 값을 저장할 수 없고, 객체만 저장 가능하기 때문
...
public class BoxingUnBoxing {
    public static void main(String[] args) {
        ...
        // - 객체 값이 null 일 때 자동 언박싱 NullPointException을 발생시킬 수 있지만
        //      자료형Value() 메서드를 사용하면 더 명확한 처리 가능
        System.out.printf("int value: %d%n", obj1.intValue());  // intValue(): Integer 객체 내부의 int값 리턴
        System.out.printf("double value: %.2f%n", obj2.doubleValue());
        System.out.printf("char value: %c%n", obj3.charValue());
        System.out.println();

        // 연산 시 boxing
        int result1 = obj1 + 100;   // obj1은 100이랑 연산되기 전에 언박싱
