...
public class OptionalEx {
    public static void main(String[] args) {
        ...
        System.out.println("opt1 이 존재하는가? " + opt1.isPresent());

        // 값이 null 일수도 있는 경우(null 이면 empty Optional 생성)
        Optional<String> opt2 = Optional.ofNullable(null);
        System.out.println("opt2 가 비어있는가? " + opt2.isEmpty());

        // 비어있는 Optinal 생성
        // empty(): 생성
        Optional<String> opt3 = Optional.empty();
        System.out.println("opt3 이 존재하는가? " + opt3.isEmpty());
