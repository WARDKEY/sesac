...
public class MethodOverloading {
    public static void main(String[] args) {
        ...
        System.out.println(methodOverloading.add(1.2,2.3));
        System.out.println(methodOverloading.add(1.1,2.2, 4.4));    // 7.700000000000001
        System.out.println(methodOverloading.add("hello, ", "world"));
    }

    // 메서드 오버로딩 : 함수의 이름은 같고, 매개변수의 개수와 타입이 다름
