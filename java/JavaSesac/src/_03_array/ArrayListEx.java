...
//        numbers.add(인덱스 번호, 요소);
        ...
        System.out.println("numbers = " + numbers); // [10, 7, 30, 40, 50, 100, 99, 98]

        // 9. 리스트 크기 화인 size()
        System.out.println("리스트의 크기 : " + numbers.size());  // 8
